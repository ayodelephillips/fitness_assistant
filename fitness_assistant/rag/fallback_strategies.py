...
class FallbackRetriever:
    ...
    def _build_keyword_index(self):
        ...
        try:
            doc_texts = [
                self._extract_document_text(doc) for doc in self.documents
            ]
    ...
    def calculate_quality_score(self, results: list) -> float:
        ...
        try:
            ...
            avg_score = scores_sum / num_results if num_results > 0 else 0.0
    ...
    def generate_clarifying_questions(self, query: str) -> list[str]:
        ...
        if 'exercise' in query_lower or 'workout' in query_lower:
            ...
            questions.append("Could you clarify what type of fitness advice you're seeking?")
            questions.append("Are you looking for exercise recommendations, form tips, or training programs?")
        
        if 'equipment' not in query_lower and 'home' not in query_lower:
            questions.append("Do you have access to specific equipment (dumbbells, barbell, machines)?")
