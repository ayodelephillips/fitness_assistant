...
class TestFallbackRetrieverInitialization:
    ...
    def test_initialization_with_custom_thresholds(self, mock_vector_search_fn, sample_documents):
    ...
    def test_keyword_index_built_with_documents(self, mock_vector_search_fn, sample_documents):
...
class TestKeywordFallback:
    ...
    def test_keyword_fallback_not_triggered_when_vector_is_good(self, fallback_retriever):
...
class TestClarifyingQuestions:
    ...
    def test_clarifying_questions_for_exercise_query(self, fallback_retriever):
        ...
        questions = fallback_retriever.generate_clarifying_questions("What exercises can I do?")
    ...
    def test_clarifying_questions_non_exercise_query(self, fallback_retriever):
        ...
        questions = fallback_retriever.generate_clarifying_questions("general fitness advice")
    ...
    def test_clarifying_questions_with_equipment(self, fallback_retriever):
        ...
        questions = fallback_retriever.generate_clarifying_questions("exercises for legs")
    ...
    def test_clarifying_questions_max_count(self, fallback_retriever):
        ...
        questions = fallback_retriever.generate_clarifying_questions("exercise advice please")
...
class TestRetrieveWithFallback:
    ...
    def test_retrieve_with_fallback_generates_clarifying_questions(self, fallback_retriever):
